  ...
  <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20">
    <div className="bg-white rounded-3xl shadow-card p-8 space-y-6">
      <header className="space-y-2 text-center">
        <p className="text-sm uppercase tracking-[0.3em] text-amber font-semibold">Acceso</p>
        <h1 className="text-3xl font-bold text-slate">Inicia sesión en Tequio</h1>
        <p className="text-sm text-slate/70">
          Conecta tu cuenta para seguir tus inversiones, proyectos y métricas de impacto.
        </p>
      </header>
      ...
      <p className="text-xs text-slate/60 text-center">
        Próximamente habilitaremos login con wallets Web3 y autenticación multifactor.
      </p>
      <div className="text-sm text-center text-slate/80">
        ¿Aún no tienes cuenta?{' '}
        <Link to="/registro" className="font-semibold text-amber hover:text-amber/80">
          Crear cuenta
        </Link>
      </div>
    </div>
